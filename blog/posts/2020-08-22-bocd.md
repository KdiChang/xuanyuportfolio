...
[**Bayesian Online Changepoint Detection**](http://gregorygundersen.com/docs/2019/08/13/bocd/) (Gregory Gundersen)
...
- $p(x_t \mid r_{t-1}, x_{t-1}^{(r)})$ 和 $p(x_{t+1} \mid r_t, x_t^{(r)})$：为了方便，我们按照本文~~抄~~参考的[博客](http://gregorygundersen.com/docs/2019/08/13/bocd/)的叫法，把它称为 Underlying Probabilistic Model（UPM），它的求法将在[这一节](#upm)解释
...
<p class="desc">图片来源：<a href="http://gregorygundersen.com/docs/2019/08/13/bocd/" target="_blank">docs: Bayesian Online Changepoint Detection</a></p>
...
- [Bayesian Online Changepoint Detection](http://gregorygundersen.com/docs/2019/08/13/bocd/) (a docs by Gregory Gundersen)

- [Bayesian online change point detection — An intuitive understanding](https://medium.com/scientya/bayesian-online-change-point-detection-an-intuitive-understanding-b2d2b9dc165b) (a docs on Medium)
